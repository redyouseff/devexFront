...
const logo ="/campaign/logo.svg"
const image="/campaign/image1.svg"
const image2="/campaign/image2.png"
const whatsIcon="/campaign/whatsIcon.svg"
const yellowWhatsIcon="campaign/yellowWhatsIcon.svg"
const offer ="campaign/offer.svg"

const icon1 ="/campaign/icon1.svg"
const icon2 ="/campaign/icon2.svg"
const icon3 ="/campaign/icon3.svg"
const icon4 ="/campaign/icon4.svg"
const icon5 ="/campaign/icon5.svg"
const icon6 ="/campaign/icon6.svg"
const icon7 ="/campaign/icon7.svg"
const icon8 ="/campaign/icon8.svg"
const icon9 ="/campaign/icon9.png"
const icon10 ="/campaign/icon10.png"
const icon11 ="/campaign/icon11.png"
const arrowIcon="/campaign/arrowIcon.svg"
const li="/campaign/li.svg"
const laptop="/campaign/laptop.png"
const flag="/campaign/flag.png"

const vector1 ="/campaign/Vector.svg"
const vector2 ="/campaign/Vector2.svg"
const vector3 ="/campaign/Vector3.svg"
const vector4 ="/campaign/Vector4.svg"
        ...
        style={{ backgroundImage: `url(${image}) ` }}>
           ...
           <div className="mt-2 grid grid-cols-12 gap-4 md:gap-6 container mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
            ...
            <div className="col-span-12 md:col-span-6 order-1 md:order-2">
                ...
                <button className="mx-auto md:ml-auto md:mr-0 rounded-full border-2 border-[#2F5B44] px-6 md:px-10 py-3 md:py-4 flex items-center justify-center gap-2 mt-6 md:mt-10">
           ...
           <div className="col-span-12 lg:col-span-5 order-2 lg:order-1">
                ...
                <div className="rounded-2xl h-full bg-[#2F5B44] overflow-hidden shadow-lg">
                    ...
                    <div className="px-2 md:px-3 mt-4 shadow-lg rounded-2xl mb-5">
                        {/* Form Body */}
                        <div className="p-4 md:p-6 space-y-4 md:space-y-5 bg-[#FEF9D0] shadow-lg rounded-2xl">
                            ...
                            {/* Submit Button */}
                            <div className="pt-4">
                                <button className="bg-[#FEF9D0] rounded-3xl border-2 border-[#2F5B44] px-6 md:px-8 py-2 font-changa text-base md:text-lg flex items-center gap-2 hover:bg-[#243f33]/10 transition-colors">
            ...
            <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center" dir="rtl">
                ...
                <div className="rounded-3xl bg-[#2F5B44] border-2 border-[#2F5B44] overflow-hidden shadow-lg flex flex-col">
                    ...
                    <div className="p-5 flex-grow bg-[#FEF9D0] rounded-3xl  ">
                        ...
                        <button className="w-full rounded-full border-2 border-[#2F5B44] py-3 flex items-center justify-center gap-2 hover:bg-[#2F5B44]/10 transition-colors group">
                ...
                <img src={offer} className="absolute top-[-6%] left-0 w-24 h-24" />
                    ...
                    <div className="p-5 flex-grow bg-[#FEF9D0]/90 rounded-3xl  ">
                        ...
                        <div className="p-4 pt-0 mt-10">
                        <button className="w-full rounded-full border-2 bg-[#2F5B44]/80 border-[#2F5B44] py-3 flex items-center justify-center gap-2 hover:bg-[#2F5B44] group">
           ...
           <div className="mt-[3rem] md:mt-[8rem] container mx-auto max-w-7xl mb-10 px-4 md:px-6 lg:px-8">
            <div className="flex justify-center items-center gap-10">
                <div className="rounded-3xl bg-[#2F5B44]/70 p-10  flex w-72 px-6 pt-12 pb-16 justify-center items-center gap-4">
                <div className="flex flex-col gap-3">
                    <p className="text-right font-medium uppercase text-custom-cream text-lg font-changa">تنفيذ احترافي مع</p>
                    <p className="text-right font-medium uppercase text-custom-cream text-lg font-changa">تدريب كامل لفريقك</p>

                </div>

                <img src={icon9} className="w-16 h-16" />
               

                </div>
                <div className="rounded-3xl bg-[#2F5B44]/70 p-10 flex w-72 px-6 pt-12 pb-16 justify-center items-center gap-4">
                <div className="flex flex-col gap-3">
                    <p className="text-right font-medium uppercase text-custom-cream text-lg font-changa whitespace-nowrap">  خطط دفع مرنة تناسب</p>
                    <p className="text-right font-medium uppercase text-custom-cream text-lg font-changa">  ميزانية عملك</p>

                </div>

                <img src={icon10} className="w-16 h-16" />
                ...
                <div className="rounded-3xl bg-[#2F5B44]/70 p-10  flex w-72 px-6 pt-12 pb-16 justify-center items-center gap-4">
                <div className="flex flex-col gap-3">
                    <p className="text-right font-medium uppercase text-custom-cream text-lg font-changa whitespace-nowrap">  دعم فني مجاني لمدة</p>
                    <p className="text-right font-medium uppercase text-custom-cream text-lg font-changa">  شهرين بعد الإطلاق</p>

                </div>

                <img src={icon11} className="w-16 h-16" />
           ...
           {/* last section  */}
           <div className="grid grid-cols-12 gap-6 container mt-[15rem] relative ">
            <div className="col-span-6  bg-[#FEF9D0] p-10" >
            <ul className="mt-20 space-y-10 text-right font-medium uppercase text-[#2F5B44] text-xl font-changa">
                            <li className="flex items-start gap-2 justify-end">
                                <span className="text-right font-medium uppercase text-custom-green text-xl font-changa">    منصة واحدة تدير كل أعمالك بذكاء : اربط المبيعات، المحاسبة، المخزون والعمليات اليومية في نظام متكامل وسهل الاستخدام</span>
                                <span className="text-[#FEF9D0]">
                                <img src={li} className="w-5 h-5" />
            ...
            <div className="col-span-6 bg-[#2F5B44] p-10 rounded-l-3xl ">
                <p className="text-right font-semibold uppercase text-custom-cream text-4xl font-changa mt-10">كيف يساعدك نظام Odoo ERP على نمو أعمالك؟</p>

                <ul className="mt-20 space-y-10 text-right font-medium uppercase text-custom-cream text-xl font-changa">
                            <li className="flex items-start gap-2 justify-end">
                        ...
                        <div className="p-4 pt-0 mt-10 flex justify-end">
                        <button className="px-10   bg-[#2F5B44]/80  py-3 flex items-center justify-center gap-2 hover:bg-[#2F5B44] group rounded-full border-2 border-custom-cream">
                            <img src={yellowWhatsIcon} className="w-5 h-5" />
                            <span className="text-[#FEF9D0] font-changa font-medium ">احصل علي عرض سعر</span>
           ...
           <div className="mt-10  md:mt-[8rem] container mx-auto max-w-7xl  px-2 md:px-6 lg:px-8 border-t border-[#2F5B44] py-4 flex justify-between items-center">
            <p className="font-medium uppercase text-custom-green text-base font-inter">©2025 devext. allrights reserved</p>
            <p className="font-medium uppercase text-custom-green text-base font-inter">Privacy policy</p>
            <p className="font-medium uppercase text-custom-green text-base font-inter">Accessibility</p>
            <p className="font-medium uppercase text-custom-green text-base font-inter">Call us : 01200064762</p>
