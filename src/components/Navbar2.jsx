  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-64 bg-[#FEF9D0] transition-all duration-300 transform ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} md:hidden rounded-l-2xl`} style={{ zIndex: 9999 }}>
        ...
        <div className="flex flex-col h-full pt-16 px-8">
          ...
          <div className="flex flex-col space-y-6">
            <Link 
              to="/" 
              className="text-[#2F5B44] hover:text-[#2F5B44] transition-colors duration-200 text-xl font-medium"
            >
              Home
            </Link>
            <Link 
      ...
      <div className="relative z-10 flex items-center justify-between max-w-7xl mx-auto">
        ...
        <button 
          onClick={toggleMenu}
          className="md:hidden text-[#2F5B44] p-2"
        >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            {isMenuOpen ? (
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
        ...
        <nav className="hidden md:flex items-center justify-between w-[400px] absolute left-1/2 transform -translate-x-1/2">
          <Link 
            to="/" 
            className="text-[#2F5B44] hover:text-[#2F5B44] transition-colors duration-200"
            style={{
              fontFamily: 'Inter',
              fontWeight: 500,
              fontStyle: 'Medium',
          ...
          <div className="relative group">
            <Link 
              to="/services" 
              className="text-[#2F5B44] hover:text-[#2F5B44] transition-colors duration-200 flex items-center"
              style={{
                fontFamily: 'Inter',
                fontWeight: 500,    
                fontStyle: 'Medium',
        ...
        <div className="hidden md:flex items-center md:mr-32">
          <Link 
            to="/contact" 
            className="border-2 border-[#2F5B44] text-[#2F5B44] px-6 py-3 rounded-full hover:bg-[#2F5B44] hover:text-[#FEF9D0] transition-all duration-200 flex items-center text-xl group"
            style={{
              fontFamily: 'Inter',
              fontWeight: 500,
              fontStyle: 'Medium',
